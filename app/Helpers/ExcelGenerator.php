...
class ExcelGenerator
{
    ...
    */
    ...
    public function ExcelGenerator($file="")
    {
        return $this->open($file);
    }
    ...
    */
    ...
    function writeLine($line_arr)
    {
        ...
        foreach($line_arr as $col)
            fwrite($this->fp,"<td class=xl24 width=80 >$col</td>");
        fwrite($this->fp,"</tr>");
    }

    function writeHeader($line_arr)
    {
        if($this->state!="OPENED")
        {
            $this->error="Error : Please open the file.";
        ...
        fwrite($this->fp,"<tr>");
        foreach($line_arr as $col)
            fwrite($this->fp,"<td class=fcolor width=80><b>$col</b></td>");
        fwrite($this->fp,"</tr>");
    }
